  ...
  head: () => ({
    meta: [
      { title: "Our Services — FAGE Ghana" },
      {
        name: "description",
        content:
          "FAGE provides comprehensive support for Ghanaian exporters: advocacy, matchmaking, trade support and research.",
      },
      { property: "og:title", content: "Our Services — FAGE Ghana" },
      {
        property: "og:description",
        content:
          "Empowering Ghanaian exporters with comprehensive support, market access, and strategic resources.",
      },
      {
        property: "og:image",
        content:
...
const serviceList = [
  ...
  },
  {
    ...
    link: "https://www.modernghana.com/news/1315897/horticulture-in-ghana-to-increase-food-production.html",
  },
  {
    icon: Megaphone,
    title: "Advocacy",
        ...
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <Reveal variant="up" delay={2}>
            <p className="text-muted-foreground leading-relaxed">
              ...
              at every stage of their export journey.
            </p>
          </Reveal>
        </div>
      </section>
              ...
              <div className="rounded-2xl bg-card p-8 shadow-sm h-full">
                ...
                {s.link ? (
                  <p className="mb-5 text-muted-foreground leading-relaxed">
                    ...
                    & Comprehensive Export Insurance Solutions
                  </p>
                ) : (
