...
export const Route = createFileRoute("/products")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Quality Ghanaian products trusted by international buyers worldwide.",
      },
...
const categories = [
  {
    icon: Leaf,
    title: "Fresh Produce",
    text: "Farm-fresh fruits and vegetables harvested at peak quality.",
  },
  {
    icon: Package,
    title: "Processed Foods",
    text: "Value-added products including dried fruits, juices, and packaged goods.",
  },
  {
    icon: Award,
    title: "Export Quality",
    text: "All products meet international quality certifications and food safety standards.",
  },
  {
    icon: Sprout,
    title: "Sustainable",
    text: "Products sourced from sustainable farming practices supporting local communities.",
  },
];
...
const FEATURED = [
  ...
  },
  {
    ...
    desc: "Papaya (pawpaw) cultivation in Ghana has grown steadily, driven by favorable tropical conditions and increasing demand. It is primarily grown in the Eastern, Central, Greater Accra, and Volta Regions.",
  },
  {
    num: "04",
    title: "Vegetable Production & Export",
    img: "/images/products/showcase/04-vegetables.jpeg",
    desc: "Vegetable farming in Ghana plays a vital role in food security and economic growth, with key crops including tomatoes, onions, peppers, okra, carrots, and leafy greens.",
  },
  {
    num: "05",
    title: "Citrus Production & Export",
    img: "/images/products/showcase/05-citrus.jpeg",
    desc: "Citrus farming in Ghana, mainly involving oranges, lemons, limes, and tangerines, is a key agricultural activity, with major production areas in the Central, Eastern, Ashanti, and Brong Ahafo Regions.",
  },
  {
    num: "06",
    title: "Roots & Tubers Production & Export",
    img: "/images/products/showcase/06-roots-tubers.jpeg",
    desc: "Roots and tubers are staple crops in Ghana, contributing significantly to food security and economic development. Major crops include yam, cassava, cocoyam, and sweet potatoes.",
  },
  {
    num: "07",
    title: "Garment Production & Export",
    img: "/images/products/showcase/07-garment.jpeg",
    desc: "Ghana's garment and textile industry has a rich history, with production centered in Accra, Tema, Kumasi, and Takoradi, specializing in African print fabrics, casual and corporate wear.",
  },
  {
    num: "08",
    title: "Plant Laboratory Production & Export",
    img: "/images/products/showcase/08-plant-lab.jpeg",
    desc: "Plant laboratories in Ghana enhance agriculture through tissue culture, seed propagation, and genetic research, supporting high-yield, disease-resistant crops for local and export markets.",
  },
  {
    num: "09",
    title: "Medicinal Plants Production & Export",
    img: "/images/products/showcase/09-medicinal-plants.jpeg",
    desc: "Medicinal plant use in Ghana dates back centuries. Indigenous communities rely on herbs, roots, and tree barks like neem, hibiscus, moringa, prekese, aloe vera, and ginger.",
  },
  {
    num: "10",
    title: "Fruit Processing Production & Export",
    img: "/images/products/showcase/10-fruit-processing.jpeg",
    desc: "Fruit processing in Ghana has evolved into a thriving agro-industry producing juices, dried fruits, purees, and concentrates from pineapple, mango, papaya, and citrus.",
  },
  {
    num: "11",
    title: "Shea Butter Production & Export",
    img: "/images/products/showcase/11-shea-butter.jpeg",
    desc: "Ghana is one of the world's leading producers of shea butter, exported globally for use in cosmetics, food, and pharmaceuticals, sourced from the Northern regions.",
  },
];
        ...
        return (
          <Reveal key={p.num} variant="scale" delay={((i % 3) + 1) as 1 | 2 | 3}>
            ...
            >
              ...
              <div
                className={`absolute bottom-0 inset-x-0 px-5 pb-4 transition-all duration-300 ${
              ...
              <div
                className={`absolute inset-0 flex flex-col justify-end bg-primary/90 px-5 pb-5 pt-10 transition-all duration-300 ${
...
function ProductsPage() {
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Our Members' Products"
        title="Our Members' Products"
          ...
          <div className="mb-12 text-center">
            ...
            <Reveal variant="up" delay={2}>
              <p className="mx-auto max-w-2xl text-muted-foreground">
                FAGE members produce and export a diverse range of high-quality agricultural
      ...
      <section className="bg-muted/40 py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-12 text-center">
            ...
            <Reveal variant="up" delay={1}>
              <h2 className="mb-3 text-3xl font-bold md:text-4xl">Our Main Exports</h2>
            </Reveal>
            <Reveal variant="up" delay={2}>
              <p className="mx-auto max-w-xl text-muted-foreground">
                Click any product to learn more about it.
              </p>
            </Reveal>
          </div>
          <FeaturedGrid />
