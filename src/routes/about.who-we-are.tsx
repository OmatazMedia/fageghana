  ...
  head: () => ({
    meta: [
      { title: "Who We Are — FAGE Ghana" },
      {
        name: "description",
        content:
          "FAGE is an umbrella organization of Ghanaian exporter and product associations established in 1992, dedicated to growing non-traditional exports.",
      },
      { property: "og:title", content: "Who We Are — FAGE Ghana" },
      {
        property: "og:description",
        content: "Ghana's leading enabler of non-traditional exports since 1992.",
      },
      {
        property: "og:image",
        content:
...
const CORE_VALUES = [
  {
    title: "Consolidated Relationship",
    desc: "Networking and Continuous Learning — building lasting bonds between members, partners and markets to create a resilient export ecosystem.",
  },
  {
    title: "Innovation",
    desc: "New Product Design & Digitization — embracing technology and creative thinking to keep Ghanaian exports competitive on the world stage.",
  },
  {
    title: "Diversified Sales Channels",
    desc: "Expanding reach across multiple markets and platforms to reduce dependency and unlock new revenue streams for members.",
  },
  {
    title: "Sustainability",
    desc: "Sustainable investments in export trade — ensuring long-term growth that respects people, planet and profit equally.",
  },
  {
    title: "Continuous Capacity Building",
    desc: "Industry specific training and certifications that equip members with the skills and knowledge to meet global standards.",
  },
  {
    title: "Business Expansion",
    desc: "Revenue Generation, Standardization & Product diversification — helping members scale confidently into new territories and categories.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        className="flex-1"
        style={{
          transform: `translateY(${even ? -offset : offset}px)`,
          transition: "transform 0.1s linear",
        }}
      >
        <Reveal variant={even ? "left" : "right"}>
          <div
            className={`flex flex-col gap-3 ${even ? "lg:items-end lg:text-right" : "lg:items-start lg:text-left"}`}
          >
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <Reveal variant="up" delay={2}>
                <p className="text-muted-foreground leading-relaxed">
                  The Federation of Associations of Ghanaian Exporters (FAGE), established in 1992,
                  is a not-for-profit umbrella organization for exporters and product associations,
                  registered under Ghana's Companies Code (Act 179, 1963).
                </p>
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  ...
                  by assisting member firms in developing and marketing their products, and by
              ...
              <Reveal variant="scale" delay={3}>
                <Link
                  to="/membership"
                  className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:scale-105 transition"
                >
            ...
            <Reveal variant="right">
              ...
              >
                ...
                <div
                  className="absolute left-0 top-0 w-[78%] rounded-2xl border-4 border-primary shadow-xl overflow-hidden"
                  style={{ height: 340 }}
                >
                  <img
                ...
                <div
                  className="absolute bottom-0 right-0 w-[55%] rounded-2xl border-4 border-white ring-1 ring-border shadow-2xl overflow-hidden"
                  style={{ height: 240 }}
                >
                  <img
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <Reveal variant="left">
              <div className="rounded-2xl border border-border bg-card p-8 h-full flex flex-col">
                ...
                <h3 className="mb-4 text-xl font-bold">
                  Market Enabler for Non-Traditional Exports
                </h3>
                <p className="text-muted-foreground leading-relaxed text-sm flex-1">
                  We envision being the main market enabler organization in the promoting of
                  Non-traditional exports to foreign markets.
                </p>
            ...
            <Reveal variant="right">
              <div className="rounded-2xl border border-border bg-card p-8 h-full flex flex-col">
                ...
                <h3 className="mb-4 text-xl font-bold">
                  Promoting Exports Through Global Standards
                </h3>
                <p className="text-muted-foreground leading-relaxed text-sm flex-1">
                  FAGE leverages global best standard practices in promoting Non-traditional exports
                  to foreign markets through advocacy, member capacity building, market development
                  services, communication and FAGE facilitated funds.
                </p>
                <div className="mt-6 h-1 w-12 rounded-full bg-gradient-to-r from-primary to-primary/30" />
              </div>
            </Reveal>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 lg:grid-cols-2">
          ...
          <Reveal variant="right">
            ...
            <p className="mb-7 text-muted-foreground leading-relaxed">
              Ready to start working together? Join Ghana's premier network of exporters and gain
              access to the resources, advocacy, and markets you need to succeed globally.
            </p>
            <Link
              to="/membership"
              className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:scale-105 transition"
            >
