        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-white/70 leading-relaxed">
              The Federation of Associations of Ghanaian Exporters — promoting non-traditional
              exports since 1992.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li>
                <Link to="/about/who-we-are" className="hover:text-primary">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              ...
              <li>
                <Link to="/media" className="hover:text-primary">
                  Media Center
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Number 22, Nii Tsatse Dzani Street,
                  <br />
                  Adjiringanor, Accra
                </span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <span>
                  <a href="tel:+233535170780" className="hover:text-primary block">
                    +233 (0) 53 517 0780
                  </a>
                  <a href="tel:+233535224555" className="hover:text-primary block">
                    +233 (0) 53 522 4555
                  </a>
                </span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@fageghana.com" className="hover:text-primary">
                  info@fageghana.com
                </a>
              </li>
            </ul>
